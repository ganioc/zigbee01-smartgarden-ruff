...
var ATTRID_BASIC_SMARTGARDEN_TYPE1_SENSOR_ENABLE     =       0x4017;
...
var COMMAND_TYPE1_SOIL_ENABLE      =0x14;
...
var mapParam2HA = {
    ...
    20:{
	content:  'PARAM_ID_TYPE1_SENSOR_ENABLE',
	clusterId: ZCL_CLUSTER_ID_GEN_BASIC,
	attrId:    ATTRID_BASIC_SMARTGARDEN_TYPE1_SENSOR_ENABLE
    },    
    129:{
...
var mapCmd2HA = {
    ...
    20:{
	content: 'CMD_TYPE1_SOIL_ENABLE',
	clusterId: ZCL_CLUSTER_ID_GEN_ON_OFF,
	cmdId:     COMMAND_TYPE1_SOIL_ENABLE 
    },
    21:{
	content: 'CMD_TYPE1_SOIL_DISABLE',
	clusterId: ZCL_CLUSTER_ID_GEN_ON_OFF,
	cmdId:     COMMAND_TYPE1_SOIL_DISABLE 
    },
    22:{
	content: 'CMD_TYPE1_PH_ENABLE',
	clusterId: ZCL_CLUSTER_ID_GEN_ON_OFF,
	cmdId:     COMMAND_TYPE1_PH_ENABLE 
    },
    23:{
...
function convertRDataFormat(attrId, value){
	...
	out.sensorEnalbe = value.readUInt16BE(20);

	var flag = out.sensorEnalbe & 0xffff;

	if( (flag & 0x1) == 0){
	    // delete soil temp, soil humi
	    delete out.soilTemp;
	    delete out.soilHumi;
	}
	if( (flag & 0x2 ) == 0){
